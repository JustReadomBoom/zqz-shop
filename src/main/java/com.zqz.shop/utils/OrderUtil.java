...
public class OrderUtil {
	...
	public static String orderHtmlText(Order order, String orderIds, List<OrderGoods> orderGoodsList) {
		String orderStr = "";
		if (orderGoodsList == null || orderGoodsList.size() < 1) {// 无商品时，设置商品信息为null
			orderStr = null;
		} else {
			for (OrderGoods dog : orderGoodsList) {
				orderStr = orderStr
						+ "<br>&nbsp;&nbsp;&nbsp;&nbsp;商品序列码" + "【" + dog.getGoodsSn() + "】;"
						+ "<br>&nbsp;&nbsp;&nbsp;&nbsp;商品名称" + "【" + dog.getGoodsName() + "】;"
						+ "<br>&nbsp;&nbsp;&nbsp;&nbsp;商品规格" + "【" + JSONUtil.toJsonStr(dog.getSpecifications()) + "】;"
